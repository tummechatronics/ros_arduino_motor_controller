...
#*******************************************************************************************************************************#
class M2_motor2(Plugin):
    def __init__(self, context):
        super(M2_motor2, self).__init__(context)
        # Give QObjects reasonable names
        self.setObjectName('M2_motor2')
        ...
        # Give QObjects reasonable names
        self._widget.setObjectName('M2-2-controller')
...
#*******************************************************************************************************************************#
        self.pub_gui_talker = rospy.Publisher('M2_2_Frontend', String, queue_size=10)
        rospy.Subscriber('M2_2_Backend', String, self.m_callback)
